...
public class Rezerwacja {
    ...
    public Rezerwacja(RezerwacjaForm rezerwacjaForm, Uzytkownik uzytkownik){
        this(rezerwacjaForm.getHotel(),
                rezerwacjaForm.getPokoj(),
                uzytkownik,
                rezerwacjaForm.getPoczatekRezerwacji(),
                rezerwacjaForm.getKoniecRezerwacji());
    }
